...
const data = {
    ...
    Fallen: ['Fallen'],
    Imperium: ['Adepta Sororitas', {'Adeptus Astares': ['Black Templars', 'Blood Angel', 'Dark Angles', 'Deathwatch', 'Imperial Fists', 'Iron Hands', 'Raven Guards', 'Salamanders', 'Space Wolves', 'Ultramarines', 'White Scars']}, 'Adeptus Astra Telepathica', 'Adeptus Custodes', 'Adeptus Mechanicus', 'Astra Militarum', 'Blackstone Fortress', 'Death Korps of Krieg', 'Elucidian Starstriders', 'Elysian Drop Troops', 'Grey Knights', 'Imperial Knights', 'Inquisition', 'Legion of the Damned', 'Officio Assassinorum', 'Sisters of Silence', 'Titan Legions'],
    Necrons: ['Necrons'],
    Orks: ['Orks'],
    "T'au": ["T'au Empire"],
